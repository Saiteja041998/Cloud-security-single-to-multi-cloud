...
public class FTPUpload extends HttpServlet
{
	...
	private static String CLOUD1="ftp://drivehq.com/cloud1";
/*	private static String CLOUD1="ftp://dhsinformatics.com/cloud1";*/
	private static String CLOUD2="ftp://drivehq.com/cloud2";
	private static String CLOUD3="ftp://drivehq.com/cloud3";
	private static String CLOUD4="ftp://drivehq.com/cloud4";
	...
	{
		System.out.println("its came inside FTPUpload class");
	       ...
	       { 
				...
				try
				{
					...
					*/
					...
					String	path = (String) session.getAttribute("filepath").toString();
					System.out.println("Source ::> "+path);
				...
				/*	String ftpserver = "dhsinformatics.com";*/
			        ...
			        String ftpusername = "BHOOMIKASURESH33";
	        		...
	        		System.out.println("7777777777777777777777777777777"+uploadedClouds);
	        		...
	        		if(clouds.length!=0)
	        		{
	        			...
	        			{
	        				System.out.println("cloud is >>>>>>>>>>>>>>>>>>>>>>>>>>"+clouds[i]);
					...
					if(list.size()>0)
					{
						...
						{
							System.out.println("priya cloud id>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> "+list.get(i));
