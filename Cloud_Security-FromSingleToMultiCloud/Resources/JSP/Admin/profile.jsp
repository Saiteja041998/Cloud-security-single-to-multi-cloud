...
<head>
	...
	<script type="text/javascript" >
		        ...
		        {
		            /* alert("please give correct format"); */
...
<!-- Display Contents (Starts) -->
					...
					<div align="right" style="position:absolute;top:200px;left:475px">
						<input type="submit" onblur="validateEmail();" value="Save Updates" class="gradientbuttons"/>&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<table>
							...
							<tr>
									...
									<td>:</td>
									<td>
								    <input type="text" class="field" name="email" id = "email" onblur="validateEmail(this);" > </li>							
							 <span id="email123" ></span>
									</td>
							</tr>
