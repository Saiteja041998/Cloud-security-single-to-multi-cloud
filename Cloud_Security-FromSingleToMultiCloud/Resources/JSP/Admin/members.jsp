			...
			<table id="login" align="center">
				...
				<input type="hidden" name="add1" value="YES"></input>
					...
					<tr align="center">
							...
							<td >:</td>
							<td> 
						    <input type="password" " class="field"  id="password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" required></input>
							</td>
					</tr>
					...
					<tr align="center">
							...
							<td>:</td>
							<td> 
								<input class="field" type="text" name="mobile"  required="yes"  pattern="[7-9]{1}[0-9]{9}"  maxlength="10" height="10" />
							</td>
					</tr>
