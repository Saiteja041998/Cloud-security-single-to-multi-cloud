...
public final class profile_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t        {\r\n");
      out.write("\t\t            /* alert(\"please give correct format\"); */\r\n");
      out.write("\t\t        \t/* var emailField = document.getElementById('email').value;  */\r\n");
      out.write("\t\t        var reg = /^([A-Za-z0-9_\\-\\.])+\\@([A-Za-z0-9_\\-\\.])+\\.([A-Za-z]{2,4})$/;\r\n");
      out.write("\t\t    \r\n");
      out.write("\t\t\r\n");
      out.write("\t\t        if (reg.test(emailField.value) == false) \r\n");
      out.write("\t\t        {\r\n");
      out.write("\t\t        \t document.getElementById('email123').innerHTML=\"Invalid Email Address\";\r\n");
	...
	else if(no==2)
	{
      ...
      out.write("\t\t\t\t\t\t<input type=\"submit\" onblur=\"validateEmail();\" value=\"Save Updates\" class=\"gradientbuttons\"/>&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t\t\t\t<a class=\"gradientbuttons\" href=\"");
      out.print(request.getContextPath() );
      out.write("/ChangePass?username=");
      out.print(username );
      ...
      out.write("\t\t\t\t\t\t\t\t\t<td>:</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t    <input type=\"text\" class=\"field\" name=\"email\" id = \"email\" onblur=\"validateEmail(this);\" > </li>\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t <span id=\"email123\" ></span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<tr>\r\n");
