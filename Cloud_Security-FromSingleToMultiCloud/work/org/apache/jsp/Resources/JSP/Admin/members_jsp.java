...
public final class members_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t <script>\r\n");
      out.write("    var validating = false; \r\n");
      out.write("\t\t        function validatePass(pass)\r\n");
      out.write("\t\t        {\r\n");
      out.write("\t\t        \t//alert(\"called\")\r\n");
      out.write("\t\t        var reg = /^(?=.*\\d)(?=.*[A-Z])(.{6,15})$/;\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t        if (reg.test(pass.value) == false) \r\n");
      out.write("\t\t        {\r\n");
      out.write("\t\t        \t//alert(\"password invalid\");\r\n");
      out.write("\t\t        \t\r\n");
      out.write("\t\t         \tdocument.getElementById(\"pass123\").innerHTML = \"Password Must contain at least one number and one uppercase and lowercase letter, and  6 -15 characters a password\";\r\n");
      out.write("\t\t         \r\n");
      out.write("\t\t           pass.value = null;\r\n");
      ...
      out.write("<img src=\"");
      out.print(request.getContextPath() );
      out.write("/Resources/Images/cloud title.png\" style=\"width:100%;\"></img>\r\n");
      out.write("\r\n");
	...
	if(no == 2)
	{
      ...
      out.write("\t\t\t\t\t\t\t<td >:</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td> \r\n");
      out.write("\t\t\t\t\t\t    <input type=\"password\" \" class=\"field\"  id=\"password\" name=\"password\" pattern=\"(?=.*\\d)(?=.*[a-z])(?=.*[A-Z]).{8,}\" title=\"Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters\" required></input>\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t<tr align=\"center\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<td>:</td>\r\n");
      out.write("\t\t\t\t\t\t\t<td> \r\n");
      out.write("\t\t\t\t\t\t\t\t<input class=\"field\" type=\"text\" name=\"mobile\"  required=\"yes\"  pattern=\"[7-9]{1}[0-9]{9}\"  maxlength=\"10\" height=\"10\" />\r\n");
      out.write("\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\r\n");
